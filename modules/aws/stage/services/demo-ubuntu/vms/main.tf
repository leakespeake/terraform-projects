...
# EC2 INSTANCE - SECURITY GROUP
  security_group_name   = "demo_stg_sg"
  service_port1         = 8081
  access_port           = 22
...
module "demo_stg_eip" {
  ...
  node_count    = local.node_count
  instances_ids = module.demo_stg_ubuntu_ec2.instance_id
