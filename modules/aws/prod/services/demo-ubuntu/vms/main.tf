...
module "demo_prod_ubuntu_ec2" {
  source = "git@github.com:leakespeake/terraform-reusable-modules.git//aws/ec2?ref=b120e05"
...
module "demo_prod_eip" {
  source = "git@github.com:leakespeake/terraform-reusable-modules.git//aws/eip?ref=b120e05"
...
#   source = "git@github.com:leakespeake/terraform-reusable-modules.git//aws/route53zone?ref=b120e05"
...
module "demo_prod_r53_record" {
  source = "git@github.com:leakespeake/terraform-reusable-modules.git//aws/route53records?ref=b120e05"
...
module "demo_prod_ebs" {
  source = "git@github.com:leakespeake/terraform-reusable-modules.git//aws/ebs?ref=b120e05"
...
module "demo_prod_ebs_att" {
  source = "git@github.com:leakespeake/terraform-reusable-modules.git//aws/ebs_att?ref=b120e05"
